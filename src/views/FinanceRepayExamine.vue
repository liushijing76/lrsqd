    ...
    <div>
        ...
        <el-dialog width="30%" :title="title" :visible.sync="dialogFormVisible">
            <el-form ref="empRepayForm" :model="empRepayForm" :rules="rules" >
                ...
                <el-form-item style="width: 400px"  label="是否通过" :label-width="formLabelWidth" prop="rsno">
                    <!--  lable是单选框的value                   -->
                    <el-radio v-model="empRepayForm.rsno" label="4" @change="changeTextTrue()">通过</el-radio>
                    <el-radio v-model="empRepayForm.rsno" label="6" @change="changeTextFalse()">不通过</el-radio>
                </el-form-item>
        ...
        <el-dialog width="30%" :title="title" :visible.sync="dialogFormVisible02">
            <el-form  :model="empRepayForm" >
                ...
                <el-form-item style="width: 400px" label="驳回原因" :label-width="formLabelWidth" prop="rcause" v-if="empRepayForm.lsno== 8 || empRepayForm.lsno ==9">
                    <el-input  style="width: 320px" type="textarea" v-model="empRepayForm.rcause" readonly></el-input>
                </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            mGetRepayRecordList() {
                ...
                this.$http.post("/fGetRepayRecordList",this.select).then(res => {
            ...
            delRepayInfo() {
                ...
                this.$confirm('确认要删除选中借款信息吗','提示',{
                    ...
                    for (let i = 0; i < selection.length ; i++) {
                        if(selection[i].rsno > 1 && selection[i].rsno < 4){
