        ...
        <el-dialog width="30%" :title="title" :visible.sync="dialogFormVisible">
            <el-form ref="empLoanForm" :model="empLoanForm" :rules="rules" >
                ...
                <el-form-item style="width: 400px"  label="是否通过" :label-width="formLabelWidth" prop="lsno">
                    <!--  lable是单选框的value                   -->
                    <el-radio v-model="empLoanForm.lsno" label="4" @change="changeTextTrue()">通过</el-radio>
                    <el-radio v-model="empLoanForm.lsno" label="9" @change="changeTextFalse()">不通过</el-radio>
                </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            mGetLoanRecordList() {
                ...
                this.$http.post("/fGetLoanRecordList",this.select).then(res => {
